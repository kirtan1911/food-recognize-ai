...
<!-- Swagger Open Karva mate http://localhost:8001/docs Backend run hovu joie -->

<!-- Backend run mate cd "C:\Users\kirtan barot\Desktop\Food-Recognize\app\backend"
python -m uvicorn server:app --host 0.0.0.0 --port 8001 --reload -->

<!-- Frontend mate cd "C:\Users\kirtan barot\Desktop\Food-Recognize" yarn start -->